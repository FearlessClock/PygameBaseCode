...
class Window:
    def __init__(self, windowSize, caption, TILE_SIZE, font_renderer):
        ...
        self.animationController.addAnimations(playerAnimationUp, playerAnimationDown, playerAnimationLeft, playerAnimationRight, playerAnimationIdleUp, playerAnimationIdleDown, playerAnimationIdleLeft, playerAnimationIdleRight)
